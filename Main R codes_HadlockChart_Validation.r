...
########### IGNORE THE R CODES BELOW THIS LINE (SINCE WE DIDN'T CONSIDER IT ANYMORE##########
# Cross-validation of the Hadlock Centile Chart based on Observed Clinical Dataset
